...
class TestPipelineOrchestrator:
    ...
    def test_run_analysis_success_flow(self):
        ...
        dispatcher = Mock(spec=EventDispatcher)
        orchestrator = PipelineOrchestrator(dispatcher=dispatcher, logger=lambda msg: None)

        # Mock all service calls
        with (
            patch("services.pipeline_orchestrator.update_job_status") as mock_update,
    ...
    def test_run_analysis_handles_stage_1_failure(self):
        ...
        with (
            patch("services.pipeline_orchestrator.update_job_status"),
            patch("services.pipeline_orchestrator.extract_and_analyze_pdf") as mock_extract,
        ):
            # Make stage 1 fail
    ...
    def test_run_stage_1_extracts_and_stores_artifacts(self):
        ...
        with (
            ...
            artifacts = [{"type": "github_repo", "url": "https://github.com/user/repo"}]
    ...
    def test_run_stage_1_merges_manual_artifacts(self):
        ...
        with (
            ...
            result = orchestrator._run_stage_1("job123", "/path/to/pdf.pdf", Mock(), manual_artifacts=manual_artifacts)
            ...
            mock_store.assert_called_once_with(
                ...
                [
                    ...
                    {
                        "type": "github_repo",
                        "url": "https://github.com/user/extra-repo",
                        "description": "Manual extra repo",
                    },
                ],
            )
    ...
    def test_run_stage_3_fails_if_evaluation_returns_false(self):
        ...
        with patch.object(orchestrator, "_run_stage_3", return_value=False):
            result = orchestrator._run_stage_3("job123", Mock())
...
class TestPipelineIntegration:
    ...
    def test_pipeline_error_recovery(self):
        ...
        with (
            ...
            result = orchestrator.run_analysis("job123", "/path/to/pdf.pdf", Mock(), Mock())
