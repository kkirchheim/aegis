...
class TestPollingEndpoint:
    ...
    def test_polling_job_completion_status(self, app, auth_user):
        ...
        response = client.get(f"/api/job/completed-job/events")
        data = json.loads(response.data)
    ...
    def test_polling_access_control(self, app):
        ...
        response1 = client1.get(f"/api/job/user1-job/events")
        ...
        response2 = client2.get(f"/api/job/user1-job/events")
    ...
    def test_polling_unauthenticated_access(self, app):
        ...
        response = client.get(f"/api/job/any-job/events")
    ...
    def test_polling_response_limit(self, app, auth_user):
        ...
        response = client.get(f"/api/job/many-events-job/events")
        data = json.loads(response.data)
