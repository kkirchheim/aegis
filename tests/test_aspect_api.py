...
class TestListPluginsEndpoint:
    ...
    def test_list_plugins_custom_and_default(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            PluginService.get_or_create_default_plugins(test_user["id"])
            PluginService.create_custom_plugin(test_user["id"], "My Custom Plugin", "Custom desc", "Custom prompt")
    ...
    def test_list_plugins_user_isolation(self, client, app, test_user, create_test_user):
        ...
        with app.app_context():
            ...
            PluginService.create_custom_plugin(test_user["id"], "User 1 Custom", "Desc", "Prompt")

            # User 2 creates different custom plugin
            PluginService.create_custom_plugin(user2_id, "User 2 Custom", "Desc", "Prompt")
...
class TestCreatePluginEndpoint:
    ...
    def test_create_plugin_returns_201_with_user_plugin(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            response = client.post(
                "/api/plugins", json={"name": "Test", "description": "Test desc", "prompt": "Test prompt"}
            )
    ...
    def test_create_plugin_missing_required_field(self, client, test_user):
        ...
        # Missing 'prompt'
        response = client.post("/api/plugins", json={"name": "Test", "description": "Test desc"})
    ...
    def test_create_plugin_unauthenticated(self, client):
        ...
        response = client.post("/api/plugins", json={"name": "Test", "description": "Desc", "prompt": "Prompt"})
        assert response.status_code == 401
...
class TestUpdatePluginEndpoint:
    ...
    def test_update_custom_plugin_name(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            custom = PluginService.create_custom_plugin(
                test_user["id"], "Original Name", "Original Desc", "Original Prompt"
            )
            plugin_id = custom["id"]

            # Execute
            response = client.put(f"/api/plugins/{plugin_id}", json={"name": "Updated Name"})
    ...
    def test_update_custom_plugin_description_and_prompt(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            custom = PluginService.create_custom_plugin(test_user["id"], "Name", "Old Desc", "Old Prompt")
            plugin_id = custom["id"]

            # Execute
            response = client.put(f"/api/plugins/{plugin_id}", json={"description": "New Desc", "prompt": "New Prompt"})
    ...
    def test_update_default_plugin_forbidden(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            # Execute
            response = client.put(f"/api/plugins/{default['id']}", json={"name": "New Name"})
    ...
    def test_update_plugin_unauthenticated(self, client):
        ...
        response = client.put("/api/plugins/00000000-0000-0000-0000-000000000000", json={"name": "New"})
        assert response.status_code == 401
...
class TestDeletePluginEndpoint:
    ...
    def test_delete_custom_plugin(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            # Setup: Create custom plugin
            custom = PluginService.create_custom_plugin(test_user["id"], "Custom", "Desc", "Prompt")
            plugin_id = custom["id"]
...
class TestActivatePluginEndpoint:
    ...
    def test_activate_plugin(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            # Execute
            response = client.post(f"/api/plugins/{plugin_id}/activate", json={"is_active": True})
    ...
    def test_deactivate_plugin(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            # Execute
            response = client.post(f"/api/plugins/{plugin_id}/activate", json={"is_active": False})
    ...
    def test_activate_nonexistent_plugin(self, client, test_user):
        ...
        fake_id = "00000000-0000-0000-0000-000000000000"
        response = client.post(f"/api/plugins/{fake_id}/activate", json={"is_active": True})
    ...
    def test_activate_plugin_unauthenticated(self, client):
        ...
        response = client.post("/api/plugins/00000000-0000-0000-0000-000000000000/activate", json={"is_active": True})
        assert response.status_code == 401
...
class TestOverridePromptEndpoint:
    ...
    def test_set_custom_prompt(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            # Setup
            custom = PluginService.create_custom_plugin(test_user["id"], "Custom", "Desc", "Original Prompt")
            plugin_id = custom["id"]

            # Execute
            response = client.post(
                f"/api/plugins/{plugin_id}/override-prompt", json={"custom_prompt": "My Custom Override"}
            )
    ...
    def test_revert_to_default_prompt(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            custom = PluginService.create_custom_plugin(test_user["id"], "Custom", "Desc", "Default Prompt")
            plugin_id = custom["id"]
            PluginService.override_prompt(test_user["id"], UUID(plugin_id), "Custom")

            # Execute: Revert with null
            response = client.post(f"/api/plugins/{plugin_id}/override-prompt", json={"custom_prompt": None})
    ...
    def test_override_prompt_nonexistent_plugin(self, client, test_user):
        ...
        fake_id = "00000000-0000-0000-0000-000000000000"
        response = client.post(f"/api/plugins/{fake_id}/override-prompt", json={"custom_prompt": "New"})
    ...
    def test_override_prompt_unauthenticated(self, client):
        ...
        response = client.post(
            "/api/plugins/00000000-0000-0000-0000-000000000000/override-prompt", json={"custom_prompt": "New"}
        )
        assert response.status_code == 401
...
class TestIntegration:
    ...
    def test_full_workflow_create_override_activate(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            create_response = client.post(
                "/api/plugins",
                json={"name": "Workflow Plugin", "description": "Test workflow", "prompt": "Original prompt"},
            )
            ...
            override_response = client.post(
                f"/api/plugins/{global_plugin_id}/override-prompt", json={"custom_prompt": "Custom override"}
            )
    ...
    def test_multi_user_isolation(self, client, app, test_user, create_test_user):
        ...
        with app.app_context():
            ...
            user1_create = client.post(
                "/api/plugins", json={"name": "User 1 Plugin", "description": "Only for user 1", "prompt": "Prompt"}
            )
    ...
    def test_default_plugins_protected_from_modification(self, client, app, test_user):
        ...
        with app.app_context():
            ...
            update_response = client.put(f"/api/plugins/{default_id}", json={"name": "Hacked Name"})
