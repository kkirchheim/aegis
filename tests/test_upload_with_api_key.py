...
class TestUploadWithAPIKey:
    ...
    def test_upload_with_api_key(self, authenticated_user, client):
        ...
        with open(pdf_path, "rb") as f:
            response = client.post(
                "/api/job/upload",
                data={"pdf": f, "manual_artifact_urls": "https://github.com/example/repro-repo"},
    ...
    def test_upload_without_auth(self, client):
        ...
        response = client.post("/api/job/upload", data={"pdf": (BytesIO(pdf_content), "test.pdf")})
    ...
    def test_upload_with_session_still_works(self, authenticated_user):
        ...
        with open(pdf_path, "rb") as f:
            response = authenticated_user.post("/api/job/upload", data={"pdf": f})
