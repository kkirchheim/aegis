...
class TestHTTPMethods:
    ...
    def test_patch_for_user_status(self, admin_user, test_user):
        ...
        response = admin_user.patch(f"/api/admin/users/{test_user['id']}", json={"is_active": False})
...
class TestAuthenticationErrors:
    ...
    def test_invalid_auth_token(self, client, auth_test_job):
        ...
        response = client.get(f"/api/job/{auth_test_job['id']}", headers={"Authorization": "Bearer invalid"})
