...
class TestAuthLogin:
    ...
    def test_login_invalid_password(self, client, app):
        ...
        response = client.post("/api/auth/login", json={"username": username, "password": "wrongpassword"})
    ...
    def test_login_nonexistent_user(self, client):
        ...
        response = client.post("/api/auth/login", json={"username": "nonexistent", "password": "anypassword"})
...
class TestChangePassword:
    ...
    def test_change_password_wrong_current(self, authenticated_user):
        ...
        response = authenticated_user.post(
            "/api/auth/change-password",
            json={"old_password": "wrongpassword", "new_password": "NewPass456!", "confirm_password": "NewPass456!"},
        )
