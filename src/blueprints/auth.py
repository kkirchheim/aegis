...
from utils.validators import validate_email, validate_password, validate_passwords_match, validate_username
...
def profile():
    ...
    try:
        ...
        return render_template("profile.html", username=username, email=email, created_at=created_at)
    except Exception:
        return redirect("/")
...
def register_form():
    ...
    try:
        ...
        return jsonify({"message": "Account created. Awaiting activation by admin.", "redirect": "/login"}), 201
