...
from schemas import ErrorSchema, UpdateUserStatusSchema, UserActionSchema, UserListSchema
...
def update_user_status(user_id, is_active):
    ...
    try:
        ...
        return {"ok": True, "message": f"User {user.username} {action} successfully"}
    except Exception as e:
        from flask import current_app
...
def delete_user(user_id):
    ...
    try:
        ...
        from models.database import Artifact, Event, ExecutionDetails, PaperAnalysis, PluginEvaluation
